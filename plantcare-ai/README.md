...
projet *MSI-5-26-BD* (Tina, Kaavya, Nathan, Thomas · client Zineb Lamri).
...
src/plantcare/
  ...
  adapters/       # llm_gateway (A) · vision_model (B) · watering_model (C)
...
- **M1** critères d'acceptation : F1 > 0.70 ✅, pipeline idempotent ✅,
  3 options exploitables ✅, model cards ✅, README + schéma ✅.
...
- **Inférence (A) vs fine-tuning (B)** : l'Option A *appelle* un LLM ; l'Option B
  *met à jour des poids*. Ne pas confondre.
